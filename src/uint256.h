...
//    unsigned int GetSerializeSize(int nType=0, int nVersion=ABC_PROTOCOL_VERSION) const
...
//    void Serialize(Stream& s, int nType=0, int nVersion=ABC_PROTOCOL_VERSION) const
    ...
    template<typename Stream>
//    void Unserialize(Stream& s, int nType=0, int nVersion=ABC_PROTOCOL_VERSION)
